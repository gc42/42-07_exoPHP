...
--
-- Hôte : localhost
-- Généré le :  ven. 16 fév. 2018 à 16:53
...
--
-- Création :  ven. 16 fév. 2018 à 10:35
-- Dernière modification :  ven. 16 fév. 2018 à 10:35
--
...
--
-- RELATIONS POUR LA TABLE `jeux_video`:
--
...
INSERT IGNORE INTO `jeux_video` (`ID`, `nom`, `possesseur`, `console`, `prix`, `nbre_joueurs_max`, `commentaires`) VALUES
...
--
-- Création :  ven. 16 fév. 2018 à 10:39
-- Dernière modification :  ven. 16 fév. 2018 à 16:48
--
...
CREATE TABLE IF NOT EXISTS `minichat` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=146 DEFAULT CHARSET=utf8 COMMENT='Pour le projet Minichat''';
