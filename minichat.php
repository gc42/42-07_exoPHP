<?php
// Formulaire de saisie et affichage des anciens messages
...
<body>
	...
	<form method="post" action="minichat_post.php">
		...
		<input type="text" name="pseudo" id="pseudo" size="13" maxlength="12">
		...
		<textarea name="message" id="message" rows="5" cols="50" maxlength="255"></textarea><br />
